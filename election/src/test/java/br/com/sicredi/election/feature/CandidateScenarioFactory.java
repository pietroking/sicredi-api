...
public class CandidateScenarioFactory {
    ...
    private static CandidateResponse createCandidateResponse() {
        ...
        candidateResponse.setCandidateId(1L);
        candidateResponse.setNumber(334L);
        candidateResponse.setName("Fulano");
        candidateResponse.setParty("SSL");
        candidateResponse.setCpf("94123018041");
