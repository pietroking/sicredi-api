...
@ApiResponses(value = {
        @ApiResponse(responseCode = "201", description = "Voto realizado",
                content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,schema = @Schema(implementation = VoteResponse.class))),
...
@Operation(summary = Constants.VOTE_SAVE_SUMMARY, description = Constants.VOTE_SAVE_DESCRIPTION)
public @interface VoteSaveCodeStardard {
}
