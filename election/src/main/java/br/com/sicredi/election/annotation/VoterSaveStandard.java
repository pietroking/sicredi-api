...
@ApiResponses(value = {
        @ApiResponse(responseCode = "201", description = "Eleitor criada",
...
@Operation(summary = Constants.VOTER_SAVE_SUMMARY, description = Constants.VOTER_SAVE_DESCRIPTION)
public @interface VoterSaveStandard {
}
