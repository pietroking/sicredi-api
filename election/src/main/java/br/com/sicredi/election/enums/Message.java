...
public enum Message {
    ...
    SESSION_ZONE_LIST_IS_EMPTY("Não existem seções nesta zona.", HttpStatus.BAD_REQUEST),
    ...
    COLLABORATOR_SESSION_LIST_IS_EMPTY("Não existem colaboradores nesta seção.", HttpStatus.BAD_REQUEST),
    ...
    VOTE_LIST_IS_EMPTY("Não existem votos computados.", HttpStatus.BAD_REQUEST),
    ...
    CANDIDATE_IS_NOT_EXIST("O candidato não existe.", HttpStatus.BAD_REQUEST),
