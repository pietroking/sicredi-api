...
@ApiResponses(value = {
        @ApiResponse(responseCode = "201", description = "Candidato criado",
...
@Operation(summary = Constants.CANDIDATE_SAVE_SUMMARY, description = Constants.CANDIDATE_SAVE_DESCRIPTION)
public @interface CandidateSaveStandard {
}
